...
export const Song = ({ songName, albumName, artist, featuringName, songId, tags, }) => {
    ...
    const [chosenTags, setChosenTags] =useState([])
        ...
        const getTaggedSongs = () => {
            fetch(`https://octopus-app-bcllm.ondigitalocean.app/taggedSongs?songId=${songId}&userId=${myVersionUserObject.id}&_expand=tag`)
    ...
    const handleSaveButtonClick = () => {
        ...
        newTaggedSongs.forEach(taggedSongs => {
            fetch(`https://octopus-app-bcllm.ondigitalocean.app/taggedSongs`, {
                method: "POST",
                headers: {
    ...
    const handleDeleteButtonClick = () => {
        ...
        const requests = taggedSongsToDelete.map(id => {
            return fetch(`https://octopus-app-bcllm.ondigitalocean.app/taggedSongs/${id}`, {
                method: "DELETE"
            });
        });
